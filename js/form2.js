function myFunction() {
  ...
  if (login == "") {
      ...
      document.getElementById("login").style.backgroundColor = '#ff0046';
  }
  else if (login != "") {
      document.getElementById("login").style.backgroundColor = '#DFF2BF';
  }
  if (pass == "") {
      document.getElementById("password").style.backgroundColor = '#ff0046';
  }
  else if (pass != "") {
      if (pass.length < 8) {
  ...
  if (pass2 == "") {
      document.getElementById("password2").style.backgroundColor = '#ff0046';
  }
      ...
      document.getElementById("text2").innerHTML = 'Passwords Didnt Match!';
      document.getElementById("meter").innerHTML = '';
      document.getElementById("password").style.backgroundColor = '#ff0046';
      document.getElementById("password2").style.backgroundColor = '#ff0046';
  }
  if(email==""){
      document.getElementById("email").style.backgroundColor = "#ff0046";
  }
  else if(email !=""){
  ...
  if(login != "" && pass != "" && pass2 != "" && pass2 == pass && gender != "" && email != ""){
      ...
      document.getElementById("text2").innerHTML = 'Registered Successfully!';
  }
}